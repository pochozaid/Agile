      ...
      <div class="columns">
         <div class="column is-9">
                  <table class="table is-hoverable is-fullwidth is-striped">
                    <th><font color="rblack">Actions</font></th>
                    <tbody>
                      <tr>
                        <td ><i class="fas fa-graduation-cap"></i></td>
                        <td>Formations</td>
                        <td><a class="button is-small is-primary" href="/list"><i class="fas fa-eye"></i>&nbsp;Consulter</a>
                        &nbsp;&nbsp;&nbsp;<a class="button is-small is-info" href="/ajout"><i class="fas fa-plus"></i>&nbsp;Ajouter</a></td>
                      </tr>
                      <tr>
                        <td ><i class="fas fa-chalkboard"></i></td>
                        <td>Unités Enseignements</td>
                        
                        <td><a class="button is-small is-info" href="/create"><i class="fas fa-plus"></i>&nbsp;Ajouter</a></td>
                      </tr>
                      <tr>
                        <td ><i class="fas fa-book-open"></i></td>
                        <td>Elements constitutifs</td>
                        
                        <td><a class="button is-small is-info" href="/createe"><i class="fas fa-plus"></i>&nbsp;Ajouter</a></td>
