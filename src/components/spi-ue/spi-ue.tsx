                  ...
                  <div class="card is-shady">
                    <div class="card-image">
                      <figure class="image is-4by3">
                        <img src="http://www.aidexpert.com/themes/default/images/cms/animations-de-formation.png" alt="Placeholder image" class="modal-button" data-target="modal-image2"/>
                      </figure>
                    </div>
                    <div class="card-content">
                      <div class="content">
                        ...
                        <p class="control">        
                       <a class="button is-link" id="showModal"  onClick={() => this.getuebynum(pst.id.codeUe)}><i class="fab fa-elementor"></i>&nbsp;Element Constitutif</a>
                        </p>
                        <p class="control" >
                            <a class="button is-danger" onClick={() => this.deletefnct(pst)}><i class="fas fa-trash-alt"></i></a>
                        </p>
                        </div>
                      </div>
                    </div>
